...
@section('content')
	    ...
	    <div class="row">
	    	<div class="col-md-4 margin-top-30 text-center signup-info-matter ">
	    		<h1 class=" text-uppercase signup-info "> Start Selling Instantly! </h1>
	    		...
	    		<ul class="list-unstyled signup-text-block margin-top-40">
	    			<li class="signup-text" ><i class="fa fa-dot-circle-o"></i> Your contact info will never be shared &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;publicly.</li>
	    			<li class="signup-text"><i class="fa fa-dot-circle-o"></i> You will only be contacted by &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SCRAPKART executives for <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;verified potential transaction.</li>
	    		</ul>
	    	</div>
			<div class="col-md-7">
	                    ...
	                    <fieldset>
							...
							<div class="row">
								...
								<select class="input-llg" name="metal">
							...
							<div class=" col-md-6 margin-15" >
								<span class="help-block">UPLOAD CAD FILE </span>
									{{Form::file('files',['class' => 'form-control btn input-lg'])}}
